...
MQTT_USERNAME  = "GETFROMCAYENNEDASHBOARD"
MQTT_PASSWORD  = "GETFROMCAYENNEDASHBOARD"
MQTT_CLIENT_ID = "GETFROMCAYENNEDASHBOARD"
...
# Read the total lux, IR, and visible light levels and print it every second.
    while True:
        ...
        client.virtualWrite(1, lux, "lum", "lux")
        client.virtualWrite(2, infrared, "infrared", "null")
        client.virtualWrite(3, visible, "visable", "null")
        client.virtualWrite(4, full_spectrum, "Full spectrum (visible + IR)", "null")
